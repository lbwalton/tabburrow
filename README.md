...
**Your tabs, saved in one click, organized by AI, yours forever. No account required.**
...
| Cloud sync across devices | — | Yes | Yes (your Supabase) |
| Shareable collection pages | — | Yes | Yes (your Supabase) |
